...
# 
#                         plotOutput("time_series",height=700),
# 
...
uiTimeSeries <- function(csite, img_frmt) {
  ...
  fluidRow(
    shinydashboard::box(width = 2, status = "warning", title = "Settings",            #### Alignment should be done to properly distribute the unused space
    ...
    shinydashboard::box(width = 10, status = "primary",
                        ...
                        ####   Graphs to recalculate the plot for the time range selected on the slider bar
