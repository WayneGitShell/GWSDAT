...
GWSDAT_Options[['SiteName']]<-'GWSDAT Example'
...
GWSDAT_Options[['WellDataFilename']] <- 'D:/1_Arbeit/1_GWSDAT/3_Shiny_Dev/Shiny_GWSDAT/data/ComprehensiveExample_WellData.csv'
GWSDAT_Options[['WellCoordsFilename']] <- 'D:/1_Arbeit/1_GWSDAT/3_Shiny_Dev/Shiny_GWSDAT/data/ComprehensiveExample_WellCoords.csv'
GWSDAT_Options[['ShapeFileNames']] <- 'D:/1_Arbeit/1_GWSDAT/3_Shiny_Dev/Shiny_GWSDAT/data/GIS_Files/GWSDATex2.shp'

# Correct code (revert to this one):
#if (!require(GWSDAT))
#   devtools::install_github("andrejadd")
